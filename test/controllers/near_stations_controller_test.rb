...
class NearStationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create near_station" do
    assert_difference('NearStation.count') do
      post near_stations_url, params: { near_station: { line_name: @near_station.line_name, name: @near_station.name, real_estate_id: @near_station.real_estate_id, take_minutes: @near_station.take_minutes } }
    end
  ...
  test "should update near_station" do
    patch near_station_url(@near_station), params: { near_station: { line_name: @near_station.line_name, name: @near_station.name, real_estate_id: @near_station.real_estate_id, take_minutes: @near_station.take_minutes } }
